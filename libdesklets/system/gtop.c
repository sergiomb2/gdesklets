...
PyDoc_STRVAR(struct_doc, "Nothing at the moment...");
...
static inline PyObject * get_smp_cpu(glibtop_cpu *buf, guint i)
{
    PyObject *d;
...
static inline PyObject * get_smp_time(glibtop_proc_time *buf, guint i)
{
    PyObject *d;
