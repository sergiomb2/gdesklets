...
static void
_struct_build_repr (StructObject *that)
{
    GString *str;
    PyObject *items;
    gint i;
...
/* borrows kw */
static
PyObject * _struct_new (PyObject *kw)
{
...
static
PyObject * struct_items (PyObject *self, PyObject *args)
{
...
static PyObject *
build_128bit_long (guint64 values[2])
{
    PyObject *res, *x, *y;
...
static PyObject *
gtop_loadavg (PyObject *self, PyObject *args)
{
    glibtop_loadavg buf;
    PyObject *d;
...
static PyObject *
gtop_uptime (PyObject *self, PyObject *args)
{
    glibtop_uptime buf;
    PyObject *d;
...
static PyObject *
gtop_fsusage (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_proc_args (PyObject *self, PyObject *args)
{
...
mountentry_to_Struct (const glibtop_mountentry *e)
{
    PyObject *d;
...
static PyObject *
gtop_mountlist (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_mem (PyObject *self, PyObject *args)
{
    glibtop_mem buf;
    PyObject *d;
...
static PyObject *
gtop_swap (PyObject *self, PyObject *args)
{
    glibtop_swap buf;
    PyObject *d;
...
static void
hash_table_to_dict_cb (gpointer key, gpointer value, gpointer user_data)
{
...
static PyObject *
gtop_sysinfo (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_netlist (PyObject *self, PyObject *args)
{
    glibtop_netlist buf;
    PyObject *t;
    char **devices;
...
static char *
hwaddress_format_for_display (const glibtop_netload *buf,
...
static PyObject *
gtop_netload (PyObject *self, PyObject *args)
{
    glibtop_netload buf;
    union {
    ...
    my_dict_add_and_decref (d, "subnet",
                            PyS_S (inet_ntop (AF_INET, &buf.subnet, addr.ip4,
                                   sizeof addr.ip4)));
    my_dict_add_and_decref (d, "address",
                            PyS_S (inet_ntop (AF_INET, &buf.address, addr.ip4,
                                   sizeof addr.ip4)));
...
static PyObject *
gtop_proclist (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_ppp (PyObject *self, PyObject *args)
{
    glibtop_ppp buf;
    PyObject *d;
    gushort dev;
...
static inline PyObject *
_get_smp_cpu (glibtop_cpu *buf, guint i)
{
    PyObject *d;
...
static PyObject *
gtop_cpu (PyObject *self, PyObject *args)
{
    glibtop_cpu buf;
    PyObject *d;
    PyObject *smp;
    ...
    while  (i < GLIBTOP_NCPU && buf.xcpu_total[i] != 0) {
        ncpu ++;
        i++;
    }

    if  (ncpu == 1)
        ncpu = 0; /* zero if single-processor */

    smp = PyTuple_New (ncpu);

    for  (i = 0; i < ncpu; ++i) {
        PyObject *a;
        a = _get_smp_cpu (&buf, i);
...
static PyObject *
gtop_proc_state (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_proc_kernel (PyObject *self, PyObject *args)
{
...
static inline PyObject *
map_entry_to_Struct (const glibtop_map_entry *e)
{
    PyObject *d;
...
static PyObject *
gtop_proc_map (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_proc_mem (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_proc_segment (PyObject *self, PyObject *args)
{
...
static PyObject *
gtop_proc_signal (PyObject *self, PyObject *args)
{
...
static inline PyObject *
_get_smp_time (glibtop_proc_time *buf, guint i)
{
    PyObject *d;
...
static PyObject *
gtop_proc_time (PyObject *self, PyObject *args)
{
    ...
    while (i < GLIBTOP_NCPU && cpubuf.xcpu_total[i] != 0) {
       ncpu ++;
       i++;
    }
...
static PyObject *
gtop_proc_uid (PyObject *self, PyObject *args)
{
    ...
    ADD_ARRAY_TO_DICT2 (d, "groups", PyL_UL, buf.groups, (guint) buf.ngroups);
...
open_files_entry_to_Struct (const glibtop_open_files_entry *e)
{
    ...
    switch (e->type) {
        case GLIBTOP_FILE_TYPE_INETSOCKET:
            my_dict_add_and_decref (d, "sock_dest_host",
                                   PyS_S (e->info.sock.dest_host));
            my_dict_add_and_decref (d, "sock_dest_port",
                                   PyI_L (e->info.sock.dest_port));
            break;

        case GLIBTOP_FILE_TYPE_LOCALSOCKET:
            my_dict_add_and_decref (d, "localsock_name",
                                   PyS_S (e->info.localsock.name));
            break;
...
static PyObject *
gtop_proc_open_files (PyObject *self, PyObject *args)
{
...
{
/* hum, libgtop constant are unsigned long, but the biggest is  (1UL << 18) so
   int should be OK */
...
initgtop (void)
{
    ...
    module = Py_InitModule ("gtop", gtop_methods);
    PyType_Ready (&StructType);
